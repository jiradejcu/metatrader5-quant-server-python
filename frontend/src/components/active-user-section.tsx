...
export const ActiveUserSection = (arg: ICardSection) => {
    ...
    return (
        <>
            <p className="text-sm text-gray-600 dark:text-gray-400">Binance Holder: <span className="relative group cursor-pointer font-mono text-blue-600 dark:text-blue-400 font-bold ml-2">{activeUser?.binance_account_name}
                <span
