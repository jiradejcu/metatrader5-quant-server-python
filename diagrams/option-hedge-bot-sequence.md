...
opens a YLG fixed-time option as a standing offer against it, and streams live
PnL back to the frontend while **EXPOSED** (only the MT5 leg live, the YLG
option still just a reserved quote from `loadmp`).
